...
const cities = ['Tokyo', 'New York', 'Mexico City', 'Mumbai', 'Sao Paulo', 'Delhi', 'Shanghai', 'Kolkata', 'Los Angeles', 'Buenos Aires', 'Karachi', 'Cairo', 'Rio de Janeiro', 'Osaka', 'Beijing', 'Manila', 'Moscow', 'Istanbul', 'Paris', 'Seoul', 'Lagos', 'Jakarta', 'Guangzhou', 'Chicago', 'London', 'Lima', 'Tehran', 'Bogota', 'Shenzhen', 'Hong Kong', 'Tianjin', 'Chennai', 'Taipei', 'Bengaluru', 'Bangkok', 'Lahore', 'Chongqing', 'Miami', 'Dallas', 'Santiago', 'Philadelphia', 'Belo Horizonte', 'Madrid', 'Houston', 'Ho Chi Minh City', 'Atlanta', 'Toronto', 'Singapore', 'Luanda', 'Baghdad', 'Barcelona', 'Boston', 'Sydney', 'Chittagong', 'Riyadh', 'Hanoi', 'Guadalajara', 'Melbourne', 'Alexandria', 'Chengdu', 'Phoenix', 'Porto Alegre', 'Brasilia', 'Monterrey', 'Yokohama', 'Nanjing', 'Montreal', 'Seattle', 'San Francisco', 'Fortaleza', 'Zhangzhou', 'Detroit', 'Busan', 'Berlin', 'Rome', 'Medellin', 'Kabul', 'Athens', 'Nagoya', 'Cape Town', 'San Diego', 'Changchun', 'Casablanca', 'Cawnpore', 'Curitiba', 'Zibo', 'Nairobi', 'Benoni', 'Caracas', 'Milan', 'Stuttgart', 'Minneapolis', 'Jaipur', 'Frankfurt', 'Lisbon', 'Tampa', 'Campinas', 'Denver', 'Durban', 'Lucknow', 'Giza', 'Zhengzhou', 'Taichung', 'Brooklyn', 'Faisalabad', 'Changsha', 'Izmir', 'Xiangtan', 'Lanzhou', 'Incheon', 'Xiamen', 'George Town', 'Mashhad', 'Nagpur', 'Lianshan', 'Vienna', 'Omdurman', 'Bandung', 'Bekasi', 'Mannheim', 'Nanchang', 'Vancouver', 'Birmingham', 'Cali', 'Naples', 'Manchester', 'Puebla', 'Havana',  'Baltimore', 'Nanning', 'Belem'];
